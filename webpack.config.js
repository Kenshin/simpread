const ExtractTextPlugin = require( 'extract-text-webpack-plugin' ),
      ...
      new HtmlWebpackPlugin({
        filename: 'welcome/version_1.0.5.html',
        template: 'src/welcome/version_1.0.5.html',
        inject: true,
        minify: {
         collapseWhitespace: true,
        },
      ...
      new HtmlWebpackPlugin({
        filename: 'welcome/version_1.1.0.html',
        template: 'src/welcome/version_1.1.0.html',
        inject: true,
        minify: {
         collapseWhitespace: true,
        },
    ...
    new HtmlWebpackPlugin({
      filename: 'welcome/version_1.1.1.html',
      template: 'src/welcome/version_1.1.1.html',
      inject: true,
      minify: {
       collapseWhitespace: true,
      },
    ...
    new HtmlWebpackPlugin({
      filename: 'welcome/version_1.1.2.html',
      template: 'src/welcome/version_1.1.2.html',
      inject: true,
      minify: {
       collapseWhitespace: true,
      },
    ...
    new HtmlWebpackPlugin({
      filename: 'welcome/version_1.1.2.5005.html',
      template: 'src/welcome/version_1.1.2.5005.html',
      inject: true,
      minify: {
       collapseWhitespace: true,
      },
    ...
    new HtmlWebpackPlugin({
      filename: 'welcome/version_1.1.3.html',
      template: 'src/welcome/version_1.1.3.html',
      inject: true,
      minify: {
       collapseWhitespace: true,
      },
    ...
    new HtmlWebpackPlugin({
      filename: 'welcome/version_1.1.4.html',
      template: 'src/welcome/version_1.1.4.html',
      inject: true,
      minify: {
       collapseWhitespace: true,
      },
