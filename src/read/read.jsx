    ...
    return (
        <sr-rd-footer>
            ...
            <sr-rd-footer-copywrite>
                ...
                <div className="third">
                        <a className="sr-icon good" data-balloon="觉得不错？请帮忙投票 😄" data-balloon-pos="up" target="_blank" href="https://chrome.google.com/webstore/detail/%E7%AE%80%E6%82%A6-simpread/ijllcpnolfcooahcekpamkbidhejabll" dangerouslySetInnerHTML={{__html: good_icon }} ></a>
                    <a className="sr-icon bad" data-balloon="有待改进，请帮忙吐槽 😄" data-balloon-pos="up" target="_blank" href="" dangerouslySetInnerHTML={{__html: bad_icon  }} ></a>
                </div>
            </sr-rd-footer-copywrite>
        </sr-rd-footer>
    )
