...
嗨，你好，这里是简悦百科，包含了：新手入门，知识库，简悦的周报（每周信息汇总），简悦的开发理念，教程，使用场景，工作流等内容。

提示：如果想看详细功能说明文档的话，请通过左上角**导航进入**文档中心。
...
?> 我给新用户的建议是：从**开箱即用的阅读模式**入手，等有了更深层级需求，再研究标注 / 稍后读 / 导入 / 双向链接 / 知识图谱等信息整理方法，细节 [请看这里](入门指南（-操作指引-）)。
